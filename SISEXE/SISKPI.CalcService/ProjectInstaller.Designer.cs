namespace SISKPI.CalcService {
	partial class ProjectInstaller {
		...
		private void InitializeComponent() {
			...
			// serviceInstaller1
			// 
			this.serviceInstaller1.Description = "SIS经济指标计算程序";
			this.serviceInstaller1.DisplayName = "SISKPI.CalcService";
			this.serviceInstaller1.ServiceName = "SISKPI.CalcService";
			// 
			// ProjectInstaller
			// 
