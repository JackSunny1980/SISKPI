<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_PlantTwo.aspx.cs" Inherits="SISKPI.KPI_PlantTwo" %>
...
<body onload="setFrameHW();"  style="width: 100%; height: 100%; background-color: White;">
    ...
    <div id="divmgr" style="width: 100%; height: 100%; float: left; vertical-align: top;">
        <div id="divleft" style="width: 200px; height: 550px; float: left; vertical-align: top;">
            <iframe name="IframeLeft" width="100%" height="100%" src="KPI_PlantLeft.aspx?xml=two" runat="server"
        ...
        <div id="divright" style="width: auto; height: 550px; float: right; vertical-align: top;">
            <iframe name="IframeRight" width="100%" height="100%" src="KPIWeb\KPI_ECValue.aspx?plantcode=shb&unitcode=sh03&ecweb=JJZB"
