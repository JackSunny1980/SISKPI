...
namespace SISKPI
{
    public partial class KPI_Race : System.Web.UI.Page
    {
        ...
        void BindGrid()
        {
            ...
            dsParent.ReadXml(Server.MapPath("~/XMLMenu/RaceRootMenu.xml"));
            DataSet dsChild = new DataSet();
            dsChild.ReadXml(Server.MapPath("~/XMLMenu/RaceSubMenu.xml"));
