<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_SubRealTagSort.aspx.cs" Inherits="SISKPI.KPI_SubRealTagSort"
                                    ...
                                    <asp:GridView ID="gvTag" CssClass="GridViewStyle" Width="100%" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="序号">
                                                <ItemTemplate>
                                                    <input type="hidden" runat="server" id="said" value='<%# Eval("RealID").ToString()%>' />
                                                    <%#  Container.DataItemIndex + 1%>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="80px" />
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="RealCode" HeaderText="代码">
                                                <ItemStyle HorizontalAlign="Center" Width="80px" />
                                            </asp:BoundField>
