<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_EngunitConfig.aspx.cs"
    Inherits="SISKPI.KPI_EngunitConfig" %>
...
<body>
        ...
        <table style="width: 100%" align="center" class="table" id="table1">
            <tr style="width: 100%">
                <td align="center" style="width: 100%">
                    ...
                    <asp:Label ID="lblTitle" runat="server" Class="title" Text="单位信息"></asp:Label>
                </td>
            </tr>
            <tr style="width: 100%">
                        ...
                        <tr style="width: 100%">
                            <td style="width: 100%" align="center">
                                <span style="float: left">
                                    <asp:Label ID="Label1" runat="server" Width="80px" Text="单位:"></asp:Label>
                                    <asp:TextBox ID="txt_EngunitName" runat="server" Width="100px"></asp:TextBox>
                            ...
                            <table class="table" style="width: 98%;">
                                <tr align="left" style="width: 100%;">
                                    <td align="left" style="width: 100%;">
                                        <asp:GridView ID="gvEngunit" CssClass="GridViewStyle" Width="95%" runat="server"
                                            AutoGenerateColumns="False" EmptyDataText="没有满足条件的数据" AllowPaging="False" OnRowCancelingEdit="gvEngunit_RowCancelingEdit"
                                            OnRowEditing="gvEngunit_RowEditing" OnRowUpdating="gvEngunit_RowUpdating" OnRowDataBound="gvEngunit_RowDataBound"
                                            OnRowCommand="gvEngunit_RowCommand">
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="序号">
                                                    <ItemTemplate>
                                                        <input type="hidden" runat="server" id="engunitid" value='<%# Eval("EngunitID").ToString()%>' />
                                                        <%#  Container.DataItemIndex + 1%>
                                                    </ItemTemplate>
                                                    <HeaderStyle Width="40px" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="EngunitName" HeaderText="名称" />
                                                <asp:BoundField DataField="EngunitDesc" HeaderText="描述" ControlStyle-Width="50px"
                                                    ControlStyle-Height="20px" />
                                                <asp:BoundField DataField="EngunitNote" HeaderText="备注" ControlStyle-Width="50px" />
                                                ...
                                                <asp:TemplateField HeaderText="配置" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lb_delete" runat="server" Text="删除" CommandName="dataDelete"
                                                            CommandArgument='<%# Eval("EngunitID") %>' />
                                                    </ItemTemplate>
                                ...
                                <tr style="width: 100%">
                                    <td width="100%" align="center">
                                        <asp:Button ID="btnAddEngunit" runat="server" Text="新增单位" Width="100px" OnClick="btnAddEngunit_Click" />
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
    ...
    1px solid; padding-right: 2px; border-top: black 1px solid; padding-left: 2px; font-size: 8pt; padding-bottom: 2px;
                        border-left: black 1px solid; padding-top: 2px; border-bottom: black 1px solid">
