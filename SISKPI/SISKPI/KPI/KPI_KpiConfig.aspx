<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_KpiConfig.aspx.cs"
    Inherits="SISKPI.KPI_KpiConfig" %>
                    ...
                    <table class="table" id="table2" style="width: 100%">
                        <tr style="width: 100%">
                            <td valign="middle" align="center" style="width: 100%; height: 40px;">
                                ...
                                <asp:Label ID="lblTitle" runat="server" Class="title" Text="基础指标配置"></asp:Label>
                            </td>
                        </tr>
                        <tr style="width: 100%">
                                    ...
                                    <fieldset class="field_info" style="width: 95%;">
                                        ...
                                        <table class="table" style="width: 98%;">
                                            <tr align="left" style="width: 100%;">
                                                <td align="left" style="width: 100%;">
                                                    <asp:GridView ID="gvKpi" CssClass="GridViewStyle" Width="100%" runat="server" AutoGenerateColumns="False"
                                                        EmptyDataText="没有满足条件的数据" AllowPaging="False" OnRowDataBound="gvKpi_RowDataBound"
                                                        OnRowCommand="gvKpi_RowCommand" OnPageIndexChanging="gvKpi_PageIndexChanging"
                                                        OnRowCancelingEdit="gvKpi_RowCancelingEdit" OnRowEditing="gvKpi_RowEditing" OnRowUpdating="gvKpi_RowUpdating">
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="序号">
                                                                <ItemTemplate>
                                                                    <input type="hidden" runat="server" id="Kpiid" value='<%# Eval("KpiID").ToString()%>' />
                                                                    <%#  Container.DataItemIndex + 1%>
                                                                </ItemTemplate>
                                                                <HeaderStyle Width="40px" />
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                            <asp:BoundField DataField="KpiCode" HeaderText="代码" ControlStyle-Width="60px">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="KpiName" HeaderText="名称" ControlStyle-Width="60px">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="KpiDesc" HeaderText="描述" ControlStyle-Width="100px">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="KpiNote" HeaderText="备注" ControlStyle-Width="100px">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:TemplateField HeaderText="配置" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="delete" runat="server" Text="删除" CommandName="dataDelete" CommandArgument='<%# Eval("KpiID") %>' />
                                                                </ItemTemplate>
                                            ...
                                            <tr align="center" style="width: 100%;">
                                                <td align="center" style="width: 100%;">
                                                    <asp:Button ID="btnAddKpi" Width="120px" runat="server" Text="新增基础指标" OnClick="btnAddKpi_Click" />
                                                </td>
                                            </tr>
                                        </table>
                                    </fieldset>
