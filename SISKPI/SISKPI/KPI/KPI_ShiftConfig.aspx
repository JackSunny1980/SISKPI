<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_ShiftConfig.aspx.cs"
    Inherits="SISKPI.KPI_ShiftConfig" %>
        ...
        <table width="100%" align="left" class="table" id="table1">
            <tr style="width: 100%">
                <td align="center" style="width: 100%">
                    ...
                    <asp:Label ID="lblTitle" runat="server" Class="title" Text="值配置"></asp:Label>
                </td>
            </tr>
            <tr style="width: 100%">
                <td align="center" style="width: 100%">
                            ...
                            <table class="table" style="width: 98%;">
                                <tr align="left" style="width: 100%;">
                                    <td align="left" style="width: 100%;">
                                        <asp:GridView ID="gvShift" CssClass="GridViewStyle" Width="100%" runat="server" AutoGenerateColumns="False"
                                            EmptyDataText="没有满足条件的数据" AllowPaging="False" OnRowDataBound="gvShift_RowDataBound"
                                            OnRowCommand="gvShift_RowCommand" OnRowCancelingEdit="gvShift_RowCancelingEdit"
                                            OnRowEditing="gvShift_RowEditing" OnRowUpdating="gvShift_RowUpdating">
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="序号">
                                                    <ItemTemplate>
                                                        <input type="hidden" runat="server" id="shiftid" value='<%# Eval("ShiftID").ToString()%>' />
                                                        <%#  Container.DataItemIndex + 1%>
                                                    </ItemTemplate>
                                                    <HeaderStyle Width="40px" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="ShiftCode" HeaderText="代码" ReadOnly>
                                                    <ControlStyle Width="100px"></ControlStyle>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="ShiftName" HeaderText="名称">
                                                    <ControlStyle Width="100px"></ControlStyle>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="ShiftDesc" HeaderText="描述">
                                                    <ControlStyle Width="100px"></ControlStyle>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="ShiftNote" HeaderText="备注">
                                                    <ControlStyle Width="100px"></ControlStyle>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                ...
                                                <asp:TemplateField HeaderText="配置">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="delete" runat="server" Text="删除" CommandName="dataDelete" CommandArgument='<%# Eval("ShiftID") %>' />
                                                    </ItemTemplate>
                                ...
                                <tr align="center" style="width: 100%;">
                                    <td align="center" style="width: 100%;">
                                        <asp:Button ID="btnAddShift" Width="160px" runat="server" Text="新增值信息" OnClick="btnAddShift_Click" />
