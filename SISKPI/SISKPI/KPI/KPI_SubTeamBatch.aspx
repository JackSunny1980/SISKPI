<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_SubTeamBatch.aspx.cs"
    Inherits="SISKPI.KPI_SubTeamBatch" %>
    ...
    <table width="100%" class="table" align="center">
        <tr style="width: 100%">
            <td align="center" style="width: 100%">
                ...
                <asp:Label ID="lblTitle" runat="server" Class="title" Text="班组信息批处理"></asp:Label>
            </td>
        </tr>
        <tr style="width: 100%">
            <td align="center" style="width: 100%">
                        ...
                        <tr style="width: 100%;">
                            <td align="left" style="width: 100%;">
                                <span style="float: left">
                                    <asp:Label ID="Label1" runat="server" Text="必须确认单元、值次、人员、岗位在各配置表中存在并有效!!!"></asp:Label>
