<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_ECTagConfig.aspx.cs"
    Inherits="SISKPI.KPI_ECTagConfig" %>
                            ...
                            <td valign="middle" align="center" style="width: 100%; height: 40px;">
                                <table class="table" style="width: 98%;">
                                    <tr align="left" style="width: 100%;">
                                        ...
                                        <td style="width: 20%;">
                                            <asp:Button ID="btnBatch" Style="width: 100px" runat="server" Text="指标批处理" OnClick="btnBatch_Click" />
                                        </td>
                                        <td style="width: 20%;">
                                            <asp:Button ID="btnCheck" Style="width: 100px" runat="server" Text="指标校核" OnClick="btnCheck_Click"  Visible="false"/>
                                        </td>
                                        <td style="width: 20%;">
                                            <asp:Button ID="btnSort" Style="width: 100px" runat="server" Text="指标排序" OnClick="btnSort_Click" />
                                        </td>
                                        <td style="width: 40%;">
                                        </td>
                                    </tr>
                            ...
                            <td valign="middle" align="center" style="width: 100%; height: 40px;">
                                <table class="table" style="width: 98%;">
                                    <tr align="left" style="width: 100%;">
                                        ...
                                        <td style="width: 15%;">
                                            <asp:Label ID="Label5" runat="server" Text="指标:"></asp:Label>
                                            <select style="width: 100px" runat="server" id="ddl_ECID" name="ddlEC">
                                            </select>
                                        </td>
                                        <td style="width: 40%;">
                                            <span style="float: left">
                                                ...
                                                <asp:Button ID="btnDelete" Style="width: 100px" runat="server" Text="删 除" OnClick="btnDelete_Click" />
                                            </span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td align="center" style="width: 100%">
                                <div style="width: 100%">
                                    <fieldset class="field_info" style="width: 98%;">
                                        <legend>实时指标信息</legend>
                                        <table class="table" style="width: 98%;">
                                            <tr align="left" style="width: 100%;">
                                                <td align="left" style="width: 100%;">
                                                    <asp:GridView ID="gvEC" CssClass="GridViewStyle" Width="100%" runat="server" AutoGenerateColumns="False"
                                                        EmptyDataText="没有满足条件的数据" AllowPaging="true" PageSize="50"  OnRowDataBound="gvEC_RowDataBound"
                                                        OnRowCommand="gvEC_RowCommand" OnRowCancelingEdit="gvEC_RowCancelingEdit" 
                                                        OnRowEditing="gvEC_RowEditing" onpageindexchanging="gvEC_PageIndexChanging">
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="序号">
                                                                <ItemTemplate>
                                                                    <input type="hidden" runat="server" id="ecid" value='<%# Eval("ECID").ToString()%>' />
                                                                    <%#  Container.DataItemIndex + 1%>
                                                                </ItemTemplate>
                                                                <HeaderStyle Width="40px" />
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                            <asp:BoundField DataField="ECCode" HeaderText="代码">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="ECName" HeaderText="名称">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="ECIndex" HeaderText="显示顺序">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="CycleName" HeaderText="考核周期">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:TemplateField HeaderText="页面集" ItemStyle-HorizontalAlign="Center">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="ddlWeb" runat="server" DataSourceID="GetECWebs" DataTextField="Name"
                                                            ...
                                                            <asp:TemplateField HeaderText="是否计算" ItemStyle-HorizontalAlign="Center">
                                                                <ControlStyle Width="40px"></ControlStyle>
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="ddlAsses" runat="server" DataSourceID="GetYesNo" DataTextField="Name"
                                                                        DataValueField="Value">
                                                                    </asp:DropDownList>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="是否归零" ItemStyle-HorizontalAlign="Center">
                                                                <ControlStyle Width="40px"></ControlStyle>
                                                                <ItemTemplate>
                                                                    <asp:DropDownList ID="ddlZero" runat="server" DataSourceID="GetYesNo" DataTextField="Name"
                                                                        DataValueField="Value">
                                                                    </asp:DropDownList>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:BoundField DataField="ECWeight" HeaderText="指标权重" ItemStyle-HorizontalAlign="Center">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                            </asp:BoundField>
                                                            <asp:TemplateField HeaderText="配置" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="copy" runat="server" Text="复制" CommandName="dataCopy" CommandArgument='<%# Eval("ECID") %>' />
                                                                </ItemTemplate>
                                                                <HeaderStyle Width="40px" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="配置" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="view" runat="server" Text="浏览" CommandName="dataView" CommandArgument='<%# Eval("ECID") %>' />
                                                                </ItemTemplate>
                                                                <HeaderStyle Width="40px" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="配置" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="delete" runat="server" Text="删除" CommandName="dataDelete" CommandArgument='<%# Eval("ECID") %>' />
                                                                </ItemTemplate>
                                                                <HeaderStyle Width="40px" />
                                                            </asp:TemplateField>
                                                        </Columns>
                                            ...
                                            <tr align="center" style="width: 100%;">
                                                <td align="center" style="width: 100%;">
                                                    ...
                                                    <asp:ObjectDataSource ID="GetECWebs" runat="server" OldValuesParameterFormatString="original_{0}"
                                                        SelectMethod="GetData" TypeName="SISKPI.KPIDataSetTableAdapters.GetECWebTableAdapter">
                                                    </asp:ObjectDataSource>
                                                </td>
                                            </tr>
                                        </table>
