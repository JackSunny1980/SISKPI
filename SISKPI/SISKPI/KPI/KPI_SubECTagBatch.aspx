<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_SubECTagBatch.aspx.cs"
    Inherits="SISKPI.KPI_SubECTagBatch" %>
    ...
    <table width="100%" class="table" align="center">
        <tr style="width: 100%">
            <td align="center" style="width: 100%">
                ...
                <asp:Label ID="lblTitle" runat="server" Class="title" Text="指标批处理"></asp:Label>
            </td>
        </tr>
        <tr style="width: 100%">
            <td align="center" style="width: 100%">
                ...
                <fieldset style="width: 90%;">
                    ...
                    <table width="100%" class="table" align="center">
                        <tr align="left" style="width: 100%;">
                            <td style="width: 15%;">
                                <%--<asp:Label ID="Label4" runat="server" Text="机组集:"></asp:Label>
                        ...
                        <tr style="width: 100%;">
                            <td align="left" style="width: 100%;">
                                <span style="float: left">
                                    <asp:Label ID="Label1" runat="server" Text="必须保证机组名称、设备集名称、指标集名称、单位名称、周期名称都在相应的配置表中存在并有效!!!"></asp:Label>
