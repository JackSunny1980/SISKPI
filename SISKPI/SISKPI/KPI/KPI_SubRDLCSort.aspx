<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_SubRDLCSort.aspx.cs" Inherits="SISKPI.KPI_SubRDLCSort"
        ...
        <table width="100%" class="table" align="center">
            <tr style="width: 100%" class="table_tr">
                <td align="center" style="width: 100%">
                    ...
                    <asp:Label ID="lblTitle" runat="server" Class="title" Text="报表指标排序"></asp:Label>
                </td>
            </tr>
            <tr style="width: 100%">
                <td align="center" style="width: 100%">
                        ...
                        <table width="100%" class="table" align="center">
                            ...
                            <tr style="width: 100%">
                                <td align="left" style="width: 100%">
                                    <asp:Label ID="lblInfor" runat="server" Width="200px" Text="unit"></asp:Label>
                                </td>
                            </tr>
                            <tr style="width: 100%">
                                <td align="right" style="width: 100%">
                            ...
                            <tr style="width: 100%">
                                <td align="right" style="width: 100%">
                                    <div style="vertical-align: top; overflow: auto; width: auto;">
                                        <asp:GridView ID="gvKey" CssClass="GridViewStyle" Width="100%" runat="server" AutoGenerateColumns="False"
                                            EmptyDataText="没有满足条件的数据" AllowPaging="False" OnPageIndexChanging="gvKey_PageIndexChanging"
                                            OnRowDataBound="gvKey_RowDataBound" PageSize="100">
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="序号">
                                                    <ItemTemplate>
                                                        <input type="hidden" runat="server" id="KeyIndex" value='<%# Eval("KeyID").ToString()%>' />
                                                ...
                                                <asp:BoundField DataField="KeyEngunit" HeaderText="单位">
                                                    <ItemStyle HorizontalAlign="Left" Width="100px" />
                                                </asp:BoundField>
                                            </Columns>
                                        </asp:GridView>
