<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_ConstantConfig.aspx.cs"
    Inherits="SISKPI.KPI_ConstantConfig" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" id="mainWindow">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>SISConstant Config</title>
    <base target="_self" />
                    ...
                    <table class="table" id="table2" style="width: 100%">
                        <tr style="width: 100%">
                            <td valign="middle" align="center" style="width: 100%; height: 40px;">
                                ...
                                <asp:Label ID="lblTitle" runat="server" Class="title" Text="常量配置"></asp:Label>
                            </td>
                        </tr>
                        <tr style="width: 100%">
                                    ...
                                    <fieldset class="field_info" style="width: 95%;">
                                        ...
                                        <table class="table" style="width: 98%;">
                                            <tr align="left" style="width: 100%;">
                                                <td align="left" style="width: 100%;">
                                                    <asp:GridView ID="gvConstant" CssClass="GridViewStyle" Width="100%" runat="server"
                                                        AutoGenerateColumns="False" EmptyDataText="没有满足条件的数据" AllowPaging="False" OnRowDataBound="gvConstant_RowDataBound"
                                                        OnRowCommand="gvConstant_RowCommand" OnPageIndexChanging="gvConstant_PageIndexChanging"
                                                        OnRowCancelingEdit="gvConstant_RowCancelingEdit" OnRowEditing="gvConstant_RowEditing"
                                                        OnRowUpdating="gvConstant_RowUpdating">
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="序号">
                                                                <ItemTemplate>
                                                                    <input type="hidden" runat="server" id="constantid" value='<%# Eval("ConstantID").ToString()%>' />
                                                                    <%#  Container.DataItemIndex + 1%>
                                                                </ItemTemplate>
                                                                <HeaderStyle Width="40px" />
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:TemplateField>
                                                            <asp:BoundField DataField="ConstantCode" HeaderText="类型">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="ConstantName" HeaderText="名称">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="ConstantDesc" HeaderText="描述">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="ConstantValue" HeaderText="数值">
                                                                <ControlStyle Width="200px"></ControlStyle>
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="ConstantNote" HeaderText="备注" ControlStyle-Width="100px">
                                                                <ControlStyle Width="100px"></ControlStyle>
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:TemplateField HeaderText="配置" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="delete" runat="server" Text="删除" CommandName="dataDelete" CommandArgument='<%# Eval("ConstantID") %>' />
                                                                </ItemTemplate>
                                            ...
                                            <tr align="center" style="width: 100%;">
                                                <td align="center" style="width: 100%;">
                                                    <asp:Button ID="btnAddConstant" Width="120px" runat="server" Text="新增常量" OnClick="btnAddConstant_Click" />
