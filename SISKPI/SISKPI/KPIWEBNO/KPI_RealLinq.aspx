<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="KPI_RealLinq.aspx.cs"
    Inherits="SISKPI.KPI_RealLinq" %>
            ...
            <div style="margin: 0px; width: 100%; text-align: center;">
                <table class="table" style="width: 100%; text-align: center;">
                    ...
                    <tr style="width: 100%; text-align: center;">
                        <td style="width: 100%;" align="center">
                            <asp:GridView ID="gvReal" CssClass="GridViewStyle" Width="95%" runat="server" AutoGenerateColumns="True"
                                EmptyDataText="没有满足条件的数据" AllowPaging="False" OnRowDataBound="gvReal_RowDataBound"
                                OnRowCommand="gvReal_RowCommand">
                                ...
                                <%--<Columns>
                                    ...
                                    <asp:BoundField DataField="LinqName" HeaderText="指标名称">
                                        <ItemStyle HorizontalAlign="center" />
                                        <HeaderStyle Width="120px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="LinqEngunit" HeaderText="单位">
                                        <ItemStyle HorizontalAlign="center" />
                                        <HeaderStyle Width="120px" />
                                    </asp:BoundField>
                                </Columns>--%>
