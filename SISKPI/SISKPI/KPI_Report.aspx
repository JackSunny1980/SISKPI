<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_Report.aspx.cs" Inherits="SISKPI.KPI_Report" %>
...
<body onload="setFrameHW();" style="overflow: hidden;background-color:White;">
    ...
    <div style="width: 100%; height: 100%; margin: 0 0 0 0;" cellspacing="0">
        <div style="width: 190px; float: left; vertical-align: top;">
            <table id="kpiTable" cellspacing="0">
                <tr style="width: 100%; border: 0;" cellspacing="0">
                    ...
                    <td style="cursor: move; width: 5px; padding-right: 0px;
                        padding-left: 0px; background-image: url(Imgs/menu_td_rt_bg.gif)">
                        <img src='Imgs/menu_srco_point.gif' style="margin: 0; padding: 0">
                    </td>
                </tr>
            </table>
        </div>
        <div style="width: auto; float: left; vertical-align: top;">
            <iframe id="kpiReport" width="100%" height="100%" src="KPI\KPI_RDLCConfig.aspx" runat="server"
