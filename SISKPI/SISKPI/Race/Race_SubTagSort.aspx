<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Race_SubTagSort.aspx.cs" Inherits="SISKPI.Race_SubTagSort"
        ...
        <table width="100%" class="table" align="center">
            <tr style="width: 100%">
                <td style="width: 100%" align="center">
                    ...
                    <asp:Label ID="lblTitle" runat="server" Class="title" Text="值际竞赛标签排序"></asp:Label>
                </td>
            </tr>
            <tr style="width: 100%">
                <td style="width: 100%" align="center">
                            ...
                            <tr style="width: 100%">
                                <td style="width: 100%" align="center">
                                    <span style="float: left">
                                        <asp:Label ID="lblUnit" runat="server" Text="所属机组:"></asp:Label>
                                    ...
                                    <asp:GridView ID="gvTag" CssClass="GridViewStyle" Width="100%" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="序号">
                                                <ItemTemplate>
                                                    <input type="hidden" runat="server" id="TagIndex" value='<%# Eval("TagID").ToString()%>' />
                                                    <%#  Container.DataItemIndex + 1%>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="80px" />
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="UnitDesc" HeaderText="机组">
                                            </asp:BoundField>
                                            <asp:BoundField DataField="TagName" HeaderText="名称">
                                            </asp:BoundField>
                                            <asp:TemplateField HeaderText="描述">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDesc" runat="server" ToolTip='<%# Eval("TagDesc").ToString()%>'
                                                        Text='<%# Eval("TagDesc").ToString().Length > 10 ? Eval("TagDesc").ToString().Substring(0,10)+".." : Eval("TagDesc").ToString() %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
