...
namespace SISKPI
{
    public partial class KPI_PlantLeft : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    ViewState["xml"] = Request.QueryString["xml"].ToString();
                }
                else
                {
                    ViewState["xml"] = "";
        ...
        void BindGrid()
        {
            ...
            string xmlfile = ViewState["xml"].ToString();
            ...
            {
                dsParent.ReadXml(Server.MapPath("~/XMLMenu/" + xmlfile + "RootMenu.xml"));
                dsChild.ReadXml(Server.MapPath("~/XMLMenu/" + xmlfile + "SubMenu.xml"));
            }
