<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_SubUserConfig.aspx.cs"
    Inherits="SISKPI.KPI_SubUserConfig" %>
                    ...
                    <table style="width: 95%">
                        <tr style="width: 100%">
                            ...
                            <td style="width: 50%;" align="left">
                                <asp:TextBox ID="tbxUserCode" Width="140px" runat="server"></asp:TextBox>
                        ...
                        <tr style="width: 100%" id="trold" runat="server">
                            ...
                            <td style="width: 50%;" align="left">
                                <asp:Label ID="Label4" runat="server" Font-Size="12px" ForeColor="Red" Text="新用户默认密码为：123456"></asp:Label>
                            </td>
                        </tr>
                        <tr style="width: 100%">
                            <td style="width: 30%;">
                        ...
                        <tr style="width: 100%">
                            ...
                            <td align="left" width="50%">
                                <asp:Button ID="btnUserGroups" runat="server" Width="120px" Text="请选择..." 
                                    onclick="btnUserGroups_Click" />
                                <asp:Label ID="lblUserGroups" runat="server" Text="" Visible="false"></asp:Label>
                            </td>
                        </tr>
                        <tr style="width: 100%">
                            <td style="width: 30%;">
                            ...
                            <td style="width: 50%;" align="left">
                                <asp:RadioButtonList ID="rblUserIsValid" runat="server" RepeatDirection="Horizontal">
                        ...
                        <tr style="width: 100%">
                            ...
                            <td style="width: 50%;" align="center">
                                <span style="float: left">
                                    <asp:Button ID="btnConfirm" runat="server" Width="100px" Text="添 加" OnClick="btnConfirm_Click" />
                                </span><span style="float: inherit">
                                    <asp:Button ID="btnCancel" runat="server" Width="100px" Text="清 空" OnClick="btnCancel_Click" />
                                </span>
                            </td>
                        </tr>
                        <tr style="width: 100%">
