<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_ForShiftValue.aspx.cs"
    Inherits="SISKPI.KPI_ForShiftValue" %>
                    ...
                    <table border="0" class="frm-find" style="height: 45px;">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlUnit" runat="server" Width="120px" CssClass="select" >
                                    </asp:DropDownList>
                                </td>
                                <th>
                                ...
                                <td>
                                    <input class="Wdate" id="txt_ST" visible="true" style="width: 140px; line-height:15px" onfocus="WdatePicker({el:'txt_ST',dateFmt:'yyyy-MM-dd',skin:'whyGreen'})" type="text" runat="server" value="" />
                                </td>
                                <th>
                                    <asp:Label ID="Label2" runat="server" Text="结束时间:"></asp:Label>
                                </th>
                                <td>
                                    <input class="Wdate" id="txt_ET" visible="true" style="width: 140px; line-height:15px" onfocus="WdatePicker({el:'txt_ET',dateFmt:'yyyy-MM-dd',skin:'whyGreen'})" type="text" runat="server" value="" />
                                </td>
                                <td><input name="btnSearch" class="btnSearch" id="btn_Search" value="查 询" type="submit"/></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <ContentTemplate>
                <div style="width:100%;">
                    ...
                    <asp:GridView ID="gvData" runat="server" CssClass="table table-hover table-bordered table-condensed datagrid" 
                        AutoGenerateColumns="True" ShowFooter="True" Width="100%" 
                        EmptyDataText="没有满足条件的数据" AllowPaging="false" 
                        OnRowDataBound="gvData_RowDataBound">
                        <Columns>
                            <asp:TemplateField HeaderText="序号" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
