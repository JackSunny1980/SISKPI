<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_InputTag.aspx.cs" Inherits="SISKPI.KPI_InputTag"
        ...
        <table width="100%" class="table" align="center">
            <tr style="width: 100%">
                <td style="width: 100%" align="center">
                    ...
                    <asp:Label ID="lblTitle" runat="server" Class="title" Text="手录数据"></asp:Label>
                </td>
            </tr>
            <tr style="width: 100%">
                <td style="width: 100%" align="center">
                        ...
                        <table width="100%" class="table" align="left">
                            <tr style="width: 100%">
                                <td style="width: 100%" align="left">
                                    <asp:Label ID="lblInfor" runat="server" Text="录入时间:"></asp:Label>
                                </td>
                            </tr>
                            <tr style="width: 100%">
                                <td style="width: 100%" align="center">
                                    <asp:GridView ID="gvTag" CssClass="GridViewStyle" Width="100%" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="InputValue" HeaderText="数值">
                                                <ItemStyle HorizontalAlign="Left" Width="160px" />
                                            </asp:BoundField>
