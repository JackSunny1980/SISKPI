...
namespace SISKPI
{
    public partial class KPI_ECMonth : System.Web.UI.Page
    {
        ...
        //    if (iCheck == 1)
        //    {
        //        this.RegisterClientScriptBlock(Guid.NewGuid().ToString(), "<script>alert('检索条件不能为空');</script>");
        //    }
        //    if (iCheck == 2) 
        //    {
        //        this.RegisterClientScriptBlock(Guid.NewGuid().ToString(), "<script>alert('开始日期不能大于结束日期');</script>");   
        //    }
        //    if (iCheck == 3)
        //    {
        //        this.RegisterClientScriptBlock(Guid.NewGuid().ToString(), "<script>alert('日期不能大于今天');</script>");
        ...
        //    for (int i = 0; i < dtKPI.Rows.Count; i++)
        //    {
        //        if (dtKPI.Rows[i]["tagselected"].ToString() == "1")
        //        {
        //            strCondition += dtKPI.Rows[i]["tagdefid"].ToString() + ",";
        //        }
        //    }
