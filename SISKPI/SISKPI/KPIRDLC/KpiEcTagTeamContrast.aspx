<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KpiEcTagTeamContrast.aspx.cs"
    Inherits="RdlcReportBasic.KpiTagTeamReport.KpiEcTagTeamContrast" %>
...
<body onresize="bodyresize();">
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="rvKPI" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <LocalReport ReportPath="KpiTagTeamReport\KpiEcTagTeamContrast.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="odsTeam" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetData" TypeName="RdlcReportBasic.DsEcHourTableAdapters.KPI_Ec_TeamContrastResultTableAdapter">
            <SelectParameters>
