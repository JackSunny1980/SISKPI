<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPI_ECDay.aspx.cs" Inherits="SISKPI.KPI_ECDay" %>
                ...
                <td valign="middle" align="center" style="width: 100%;">
                    <div style="margin: 0px; width: 95%; text-align: center;">
                        <rsweb:ReportViewer ID="rvKPI" runat="server" Font-Names="Verdana" Font-Size="8pt"
                            ...
                            ZoomMode="FullPage" Width="100%" Style="margin-right: 0px" 
                            DocumentMapWidth="100%" onprerender="rvKPI_PreRender">
