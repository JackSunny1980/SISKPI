<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KpiEcTagDayChart.aspx.cs"
    Inherits="RdlcReportBasic.KpiTagDayReport.KpiEcTagDayChart" %>
...
<body  onresize="bodyresize();">
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="rvKPI" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <LocalReport ReportPath="KpiTagDayReport\KpiEcTagDayChart.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="odsDay" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetData" TypeName="RdlcReportBasic.DsEcHourTableAdapters.KPI_Ec_DayChartResultTableAdapter">
            <SelectParameters>
