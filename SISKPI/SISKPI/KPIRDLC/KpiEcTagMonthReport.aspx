<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KpiEcTagMonthReport.aspx.cs"
    Inherits="RdlcReportBasic.KpiTagMonthReport.KpiEcTagMonthReport" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function OpenOvertimeDlog(frmWin, width, height) {
            ...
            me = "KpiEcTagMonthMultiselect.aspx?action=" + action + "";
...
<body onresize="bodyresize();">
    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 700px; height: 26px; font-size: 13px;">
            <tr>
                ...
                <td style="font-size: 13px" class="style13">
                    <asp:DropDownList ID="ddlStartHour" runat="server" Width="40px" Visible="false">
            ...
            <tr>
                ...
                <td style="font-size: 13px" class="style13" align="left">
                    <asp:DropDownList ID="ddlEndHour" runat="server" Width="40px" Visible="false">
                        <asp:ListItem Selected="True">00</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td class="style12">
        ...
        <rsweb:ReportViewer ID="rvKPI" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <LocalReport ReportPath="KpiTagMonthReport\KpiEcTagMonthReport.rdlc">
                <DataSources>
