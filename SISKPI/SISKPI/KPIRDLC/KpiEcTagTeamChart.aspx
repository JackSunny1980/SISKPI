<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KpiEcTagTeamChart.aspx.cs"
    Inherits="RdlcReportBasic.KpiTagTeamReport.KpiEcTagTeamChart" %>
...
<body onresize="bodyresize();">
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="rvKPI" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <LocalReport ReportPath="KpiTagTeamReport\KpiEcTagTeamChart.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="odsTeam" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetData" TypeName="RdlcReportBasic.DsEcHourTableAdapters.KPI_Ec_TeamChartResultTableAdapter">
            <SelectParameters>
