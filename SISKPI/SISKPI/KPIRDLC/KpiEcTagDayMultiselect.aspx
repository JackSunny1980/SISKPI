<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KpiEcTagDayMultiselect.aspx.cs"
    Inherits="RdlcReportBasic.KpiTagDayReport.KpiEcTagDayMultiselect" EnableEventValidation="false" %>
...
<body style="margin: 0px 0px; font-size: 12pt;">
                            ...
                            <tr style="width: 100%;">
                                <td align="left">
                                    <div style="vertical-align: top; border-style: inset; overflow: auto; width: 95%;
                                        ...
                                        <p align="left">
                                            <asp:CheckBoxList ID="cbxKPIName" runat="server" Width="95%" Font-Size="12pt" AutoPostBack="false">
                                            </asp:CheckBoxList>
                                        </p>
                                    </div>
                                </td>
