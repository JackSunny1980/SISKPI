...
{
    public partial class KpiEcTagTeamReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                tbStartDate.Text = DateTime.Now.AddDays(-7).Date.ToString("yyyy-MM-dd");
            ...
            for (int j = 0; j < dtKPI.Rows.Count; j++)
            {
                ...
                {
                    strTip = dtKPI.Rows[j]["TAGNAME"].ToString() + "...";
                    break;
                }
            }
