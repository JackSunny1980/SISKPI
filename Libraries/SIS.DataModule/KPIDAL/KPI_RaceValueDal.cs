...
{
    public class KPI_RaceValueDal : DalBase<KPI_RaceValueEntity>
    {
        ...
        {
            string sql = "delete from Race_Snapshot ";
            if (TagID != "")
            {
        ...
        {
            string sql = "select * from Race_Snapshot";
        ...
        {
            string sql = "select count(1) from Race_Snapshot where TagName='{0}' ";
        ...
        /// <returns></returns>
        public static KPI_RaceValueEntity GetEntity(string TagID)
        {
            KPI_RaceValueEntity entity = new KPI_RaceValueEntity();

            string sql = "select * from Race_Snapshot where TagID='{0}'";
        ...
        /// <param name="UnitID"></param>
        /// <returns></returns>
        public static DataTable GetSearchListS(string UnitID)
        {
            DataTable dt  = null;

            string WorkID = "";// Race_BaseDal.GetWorkID(UnitID);
