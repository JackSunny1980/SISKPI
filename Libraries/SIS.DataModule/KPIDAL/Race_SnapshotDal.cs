...
{
    public class Race_SnapshotDal : DalBase<Race_SnapshotEntity>
    {
        ...
        /// <returns></returns>
        public static Race_SnapshotEntity GetEntity(string TagID)
        {
            Race_SnapshotEntity entity = new Race_SnapshotEntity();
        ...
        public static DataTable GetSearchListC(string UnitID)
        {
            ...
            sql = string.Format(sql, condition, UnitID);
