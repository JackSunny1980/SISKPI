namespace SIS.DataEntity
{
    ...
    public class Race_SnapshotEntity : EntityBase
    {
        ...
        public override string InsertSql
        {
            get
            {
                ...
                tmpBuild.Append("insert into Race_Snapshot(");
                if ((this.TagID == null))
                {
                }
                else
        ...
        public override string UpdateSql
        {
            ...
            {
                System.Text.StringBuilder tmpBuild = new System.Text.StringBuilder();
                tmpBuild.Append("update Race_Snapshot set ");
        ...
        public override string DeleteSql
        {
            ...
            {
                System.Text.StringBuilder tmpBuild = new System.Text.StringBuilder();
                tmpBuild.Append("delete Race_Snapshot");
                tmpBuild.Append(" where ");
                tmpBuild.Append("TagID='" + TagID + "'");
                string __tmpSql = tmpBuild.ToString();
                return __tmpSql;
        ...
        public override string SelectSql
        {
            get
            {
                ...
                tmpBuild.Append(" from Race_Snapshot");
                tmpBuild.Append(" where ");
                tmpBuild.Append("TagID='" + TagID + "'");
                string __tmpSql = tmpBuild.ToString();
                return __tmpSql;
